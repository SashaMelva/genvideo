...
const DIRECTORY_MAIN_IMG = PROJECT_DIR . DIRECTORY_SEPARATOR . 'files' . DIRECTORY_SEPARATOR . 'resources' . DIRECTORY_SEPARATOR . 'img' . DIRECTORY_SEPARATOR . 'main' . DIRECTORY_SEPARATOR;
