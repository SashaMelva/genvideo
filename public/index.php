...
define("API_KEY_YOUTUBE", $_ENV['API_KEY_YOUTUBE']);
...
const DIRECTORY_RESULT_CONTENT = PROJECT_DIR .  PROJECT_DIR .  DIRECTORY_SEPARATOR . 'var' . DIRECTORY_SEPARATOR . 'result' . DIRECTORY_SEPARATOR;
