...
const RELATIVE_PATH_IMG = 'genvideo.loc:8080' . DIRECTORY_SEPARATOR . 'files' . DIRECTORY_SEPARATOR . 'resourses' . DIRECTORY_SEPARATOR . 'img' . DIRECTORY_SEPARATOR;
...
const RELATIVE_PATH_MUSIC = 'genvideo.loc:8080' . DIRECTORY_SEPARATOR . 'files' . DIRECTORY_SEPARATOR . 'resourses' . DIRECTORY_SEPARATOR . 'music' . DIRECTORY_SEPARATOR;
const DIRECTORY_SPEECHKIT = PROJECT_DIR . DIRECTORY_SEPARATOR . 'files' . DIRECTORY_SEPARATOR . 'resourses' . DIRECTORY_SEPARATOR . 'speechkit' . DIRECTORY_SEPARATOR;
...
const DIRECTORY_ADDITIONAL_VIDEO = PROJECT_DIR . DIRECTORY_SEPARATOR . 'files' . DIRECTORY_SEPARATOR . 'video' . DIRECTORY_SEPARATOR. 'additional' . DIRECTORY_SEPARATOR;
const RELATIVE_PATH_ADDITIONAL_VIDEO ='genvideo.loc:8080' . DIRECTORY_SEPARATOR . 'files' . DIRECTORY_SEPARATOR . 'video' . DIRECTORY_SEPARATOR. 'additional' . DIRECTORY_SEPARATOR;
