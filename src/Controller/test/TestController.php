...
// Проверка, что файл успешно добавлен в архив
        ...
        $response = $client->post('https://tts.api.cloud.yandex.net/speech/v1/tts:synthesize',
            [
                'headers' => [
                    'Authorization' => 'Bearer ' . 't1.9euelZqSzpjHxsaRi5DPks2YkZ6YzO3rnpWamJiTmpbNnImPnZPPjMbHnJDl9PcNDwRV-e95eGeI3fT3TT0BVfnveXhniM3n9euelZqLkI_KnY7Mlpieys3ImImZnu_8xeuelZqLkI_KnY7Mlpieys3ImImZng.Ozuml2vDkce8R2VspF86_Ecnz_qZc37epZzEXw_gZMJdZAded3tpIB_sEsKzVskew3-el9gSyTXmSDhuTJ8YAg',
                    'x-folder-id' => 'b1glckrv5eg7s4kkhtpn',
                    'Content-Type' => 'application/x-www-form-urlencoded'
                ],
                'form_params' => [
                    'text' => 'Добро пожаловать в нашу медитацию перед сном, посвященную ощущению гармонии внутри и вокруг себя.',
                    'format' => 'mp3',
                    'lang' => "ru-RU",
                    'voice' => 'ermil',
                    'emotion' => 'good',
