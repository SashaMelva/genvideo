...
class TestController extends UserController
{
    ...
    {
        $log = new Logger('info');
        $log->pushHandler(new RotatingFileHandler('../var/log/generator-test.log', 2, Logger::INFO));
...
//        ];
        ...
        $data = $this->SplitMp3($result, 'new', $voiceSetting, $voiceSetting['delay_between_offers_ms']);
